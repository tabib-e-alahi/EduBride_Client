...
const BecomeInstructor = () => {
  return (
    <section className="sm:mt-6 lg:mt-8 mt-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-0 border-2">
      <div className="my-10 mx-auto w-11/12  flex gap-10 lg:flex-justify  lg:flex flex-col lg:flex-row-reverse lg:items-center">
        <div className="sm:text-center lg:text-left roboto-mono-font ">
          ...
          <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-sm sm:max-w-xl sm:mx-auto md:mt-5 md:text-[16px] lg:mx-0 text-justify">
            ...
            educators and inspire the next generation. As an instructor, you'll
            have the opportunity to shape minds, foster growth, and make a
            meaningful impact. Apply today to start your journey as an
            instructor!
          </p>
          {/* Button Section */}
