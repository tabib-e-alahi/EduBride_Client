...
const Footer = () => {
  return (
    <div>
      <footer className="footer bg-[#F3F7FF] text-base-content p-10">
        <nav>
          <h6 className="footer-title">Services</h6>
          <a className="link link-hover">Home</a>
          <a className="link link-hover">All Classes</a>
          <a className="link link-hover">Teach On EduBridge</a>
          <a className="link link-hover">Advertisement</a>
        </nav>
        <nav>
          <h6 className="footer-title">Company</h6>
          <a className="link link-hover">Education Services</a>
          <a className="link link-hover">Education Consultant</a>
