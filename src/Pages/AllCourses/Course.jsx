...
const Course = ({course}) => {
    const {skill_level,course_duration,lectures,Prerequisites,course_materials,course_learning,category,price,cover_image,about_this_course,course_title} = course;
 
    // console.log(course?.lectures);
    return (
        <div className="max-w-sm h-[380px] shadow-sm rounded-lg  flex flex-col justify-between noto-sans-font">
        <img className="rounded-t-xl h-3/5" src={cover_image} alt="" />
